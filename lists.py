...
print(nums[1])
# will output the value at index 1 = 10 
num = nums[2]
# saves index value 2 into num 
print(num) 
# prints value assigned to num 
...
# changing vales in a list through index
data = [5,10,15,20]
print(data) 
data[0] = 100 
...
a = [5,10] 
print(id(a)) 
# large number represents location in memory 

a = [5,10] 
b = a

# undersstanding how lists are stored 
a = [5, 10] 
b = a 
...
data = [5,10,15,20]
data_copy = data[:]
# single colon copies the list 
data[0] = 50 
print("data: {}\t daata_copy: {}".format(data, data_copy))
